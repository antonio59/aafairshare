        ...
        <div className="mt-6 bg-white rounded-lg shadow-sm p-4">
          ...
          <div className="mt-4 pt-4 border-t">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-lg">£{monthlyTotals.total.toFixed(2)}</span>
            </div>
            <div className="mt-2">
