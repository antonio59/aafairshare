...
import { RecurringExpenseWithDetails } from "~/shared/schema";
              ...
              >
                <div className="flex-1 space-y-2 mb-3 md:mb-0">
                  <div className="flex items-center">
                    <h3 className="text-lg font-medium">{recurringExpense.title || recurringExpense.description || "Recurring Expense"}</h3>
                    <Badge
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    <Badge variant="secondary" className="text-xs">
                      Paid by: {recurringExpense.paidByUser?.username || recurringExpense.paidByUser?.email?.split('@')[0] || "Unknown"}
                    </Badge>
                    <Badge variant="secondary" className="text-xs">
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete the recurring expense "{selectedExpense?.title || selectedExpense?.description || "Recurring Expense"}".
